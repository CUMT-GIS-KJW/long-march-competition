(function () {
  ...
  function buildHomeMapBackgroundSvg() {
    ...
    stopSoft.setAttribute("stop-opacity", "0.64");

    stopFade.setAttribute("offset", "82%");
    stopFade.setAttribute("stop-color", "white");
    stopFade.setAttribute("stop-opacity", "0.08");
    ...
    blurFilter.setAttribute("x", "-22%");
    blurFilter.setAttribute("y", "-22%");
    blurFilter.setAttribute("width", "144%");
    blurFilter.setAttribute("height", "144%");

    blurNode.setAttribute("stdDeviation", "3.2");
